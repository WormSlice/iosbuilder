...
export const DownloadButtons: React.FC = () => {
    return (
        <div className="flex flex-wrap gap-3 items-center justify-center">
            ...
            <a
                href="#"
                className="group flex items-center gap-2.5 glass-panel/[0.03] border border-white/[0.08] px-5 py-2 rounded-xl hover:glass-panel/[0.08] transition-all duration-300 active:scale-95"
            >
