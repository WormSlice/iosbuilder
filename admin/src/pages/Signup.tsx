        ...
        <div className="min-h-[calc(100vh-140px)] flex items-center justify-center bg-[#0a0a0a] p-4 animate-in fade-in duration-700">
            <div className="w-full max-w-[340px] space-y-6 py-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                    {/* Apple Auth Button */}
                    <button className="glass-panel text-black py-2 rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-zinc-200 transition-all flex items-center justify-center gap-2 active:scale-95">
                    ...
                    {/* Google Auth Button */}
                    <button className="glass-panel/[0.03] border border-white/[0.08] text-white py-2 rounded-xl font-black text-[9px] uppercase tracking-widest hover:glass-panel/[0.06] transition-all flex items-center justify-center gap-2 active:scale-95">
