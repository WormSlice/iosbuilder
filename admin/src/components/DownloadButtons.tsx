    ...
    return (
        <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <a
                ...
                className="group relative inline-flex items-center gap-3 bg-[#0C0D12] hover:bg-[#14161F] text-white px-5 py-3 rounded-2xl border border-white/[0.08] hover:border-white/20 transition-all duration-200 active:scale-[0.98] shadow-sm"
            >
                <div className="w-8 h-8 rounded-xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center transition-transform group-hover:scale-105">
                ...
                <div className="text-left">
                    <span className="block text-[10px] font-medium tracking-wide text-zinc-400 group-hover:text-zinc-300 transition-colors">
                        Disponible en
                    </span>
